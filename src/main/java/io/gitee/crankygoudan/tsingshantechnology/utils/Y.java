...
public class Y {
    ...
    public static String colorRandomString(@Nonnull String string) {
        ...
        return Y.colorString(string, colorList);
    }
    ...
    public static String toTextCode(@Nonnull Color color) {
        return "§x" + "§" + Y.codeColor(color.getRed() / 16) + "§" + Y.codeColor(color.getRed() % 16) + "§" + Y.codeColor(color.getGreen() / 16) + "§" + Y.codeColor(color.getGreen() % 16) + "§" + Y.codeColor(color.getBlue() / 16) + "§" + Y.codeColor(color.getBlue() % 16);
    }
