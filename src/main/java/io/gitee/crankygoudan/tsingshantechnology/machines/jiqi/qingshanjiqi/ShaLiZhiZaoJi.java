...
public class ShaLiZhiZaoJi extends QianYingHeMoBan {
    public ShaLiZhiZaoJi(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("沙砾制造机");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(0, Material.GRAVEL);
