...
public class GaoJiDinXiangFenMoBaoFaQi_JINDIN_V2 extends ChuJiDinXiangBaoFaQiMoBan {
    public GaoJiDinXiangFenMoBaoFaQi_JINDIN_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("高级定向金锭爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(1,  new ItemStack (Material.GOLD_INGOT,8));
