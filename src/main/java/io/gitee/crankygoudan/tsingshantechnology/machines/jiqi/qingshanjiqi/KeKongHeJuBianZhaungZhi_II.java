...
public class KeKongHeJuBianZhaungZhi_II extends QianYingHeMoBan {
    public KeKongHeJuBianZhaungZhi_II(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
     ...
     */
    @Override
    public int getEnergyConsumption() {return 100000000;}
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("可控核聚变装置 II");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(300, Material.NETHER_STAR);
