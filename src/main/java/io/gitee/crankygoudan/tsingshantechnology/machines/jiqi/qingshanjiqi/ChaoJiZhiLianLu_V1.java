...
public class ChaoJiZhiLianLu_V1 extends MediumContainerMachine {
  ...
  public static final SlimefunItemStack QS_CHAO_JI_ZHI_LIAN_LU_V1 = new SlimefunItemStack("QS_CHAO_JI_ZHI_LIAN_LU_V1", Material.FURNACE, Y.colorPseudorandomString("超级冶炼炉")+ " " + Y.colorPseudorandomString("II"),
  ...
  public static final ItemStack[] RECIPE_QS_CHAO_JI_ZHI_LIAN_LU_V1 = new ItemStack[]{
      QingShanCaiLiao.QS_QIANG_HUA_BAN, ChaoJiZhiLianLu_V0.QS_CHAO_JI_ZHI_LIAN_LU_V0, QingShanCaiLiao.QS_QIANG_HUA_BAN,
    ...
    public static final AbstractItemRecipe RECIPE_QIANG_HUA_DIN = new AbstractItemRecipe( new ItemStack[]{
        new SlimefunItemStack(SlimefunItems.PLUTONIUM,8), new SlimefunItemStack(SlimefunItems.REDSTONE_ALLOY,8),new SlimefunItemStack(SlimefunItems.URANIUM,8),
        new SlimefunItemStack(SlimefunItems.BLISTERING_INGOT_3,8), new SlimefunItemStack(SlimefunItems.CARBONADO,8),new SlimefunItemStack(SlimefunItems.REINFORCED_ALLOY_INGOT,8),
        new SlimefunItemStack(SlimefunItems.HARDENED_METAL_INGOT,8), new SlimefunItemStack(SlimefunItems.GOLD_22K,8),new SlimefunItemStack(SlimefunItems.NEPTUNIUM,8),
    },
        new SlimefunItemStack( QingShanCaiLiao.QS_QIANG_HUA_DIN,8));
    //强化锭
