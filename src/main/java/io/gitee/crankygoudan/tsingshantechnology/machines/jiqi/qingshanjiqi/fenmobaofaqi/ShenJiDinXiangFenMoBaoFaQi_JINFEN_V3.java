...
public class ShenJiDinXiangFenMoBaoFaQi_JINFEN_V3 extends ChuJiDinXiangBaoFaQiMoBan {
    public ShenJiDinXiangFenMoBaoFaQi_JINFEN_V3(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("神级定向金粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(1, new SlimefunItemStack ( SlimefunItems.GOLD_DUST,64));
