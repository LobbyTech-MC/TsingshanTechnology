 ...
 * @author yitoudaidai
 */
public class YuanGuJiTanGongZuoTai extends SlimefunItem implements EnergyNetComponent {
    ...
    public YuanGuJiTanGongZuoTai(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public void preRegister() {
        addItemHandler(new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem sf, Config data) {
                YuanGuJiTanGongZuoTai.this.tick(b);
            }
    ...
    private void craftIfValid(Block block, boolean craftOnce) {
        ...
        if (Constants.isSoulJarsInstalled && sfCatalyst != null
            && sfCatalyst.getId().startsWith("QFILLED") && sfCatalyst.getId().endsWith("QSOUL_JAR")) {
