...
public class ShenJiDinXiangFenMoBaoFaQi_MEIFEN_V3 extends ChuJiDinXiangBaoFaQiMoBan {
    public ShenJiDinXiangFenMoBaoFaQi_MEIFEN_V3(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("神级定向镁粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(1, new SlimefunItemStack ( SlimefunItems.MAGNESIUM_DUST,64));
