...
public class GaoJiDinXiangFenMoBaoFaQi_TIEFEN_V2 extends ChuJiDinXiangBaoFaQiMoBan {
    public GaoJiDinXiangFenMoBaoFaQi_TIEFEN_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("高级定向铁粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(1, new SlimefunItemStack ( SlimefunItems.IRON_DUST,8));
