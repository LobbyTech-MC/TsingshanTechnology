...
public class ChuJiDinXiangFenMoBaoFaQi_MEIFEN_V1 extends ChuJiDinXiangBaoFaQiMoBan {
    public ChuJiDinXiangFenMoBaoFaQi_MEIFEN_V1(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("初级定向镁粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(1, SlimefunItems.MAGNESIUM_DUST);
