...
public class DiYuYaniZhiZaoJi extends QianYingHeMoBan {
    public DiYuYaniZhiZaoJi(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("地狱岩制造机");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        this.registerRecipe(0, Material.NETHERRACK);
