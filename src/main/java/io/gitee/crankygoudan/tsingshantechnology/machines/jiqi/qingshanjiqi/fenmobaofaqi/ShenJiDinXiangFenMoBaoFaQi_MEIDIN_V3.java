...
public class ShenJiDinXiangFenMoBaoFaQi_MEIDIN_V3 extends ChuJiDinXiangBaoFaQiMoBan {
    public ShenJiDinXiangFenMoBaoFaQi_MEIDIN_V3(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("神级定向镁锭爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(1, new SlimefunItemStack ( SlimefunItems.MAGNESIUM_INGOT,64));
