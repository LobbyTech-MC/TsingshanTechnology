...
public class FenSuiJi extends AContainer implements RecipeDisplayItem {
    ...
    public FenSuiJi(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInventoryTitle() {
        return Y.colorPseudorandomString("粉碎机");
    }

    @Override
    public String getMachineIdentifier() {
        return "QS_FEN_SUI_JI";
    }
