...
public class ShenJiDinXiangFenMoBaoFaQi_TONGDIN_V3 extends ChuJiDinXiangBaoFaQiMoBan {
    public ShenJiDinXiangFenMoBaoFaQi_TONGDIN_V3(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("神级定向铜锭爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(1, new SlimefunItemStack ( SlimefunItems.COPPER_INGOT,64));
