...
public class GaoJiDinXiangFenMoBaoFaQi_JINFEN_V2 extends ChuJiDinXiangBaoFaQiMoBan {
    public GaoJiDinXiangFenMoBaoFaQi_JINFEN_V2(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    public String getInvTitle() {
        return Y.colorPseudorandomString("高级定向金粉爆发器");
    }
    ...
    public void registerDefaultRecipes() {
        ...
        registerRecipe(1, new SlimefunItemStack ( SlimefunItems.GOLD_DUST,8));
